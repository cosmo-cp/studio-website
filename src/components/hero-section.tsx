...
const DOWNLOAD_OPTIONS = {
  macOS: { label: 'Download for macOS', icon: Apple, href: 'https://github.com/Cosmo-mcp/cosmocp-desktop/releases' },
  Windows: { label: 'Download for Windows', icon: Monitor, href: 'https://github.com/Cosmo-mcp/cosmocp-desktop/releases' },
  Linux: { label: 'Download for Linux', icon: Terminal, href: 'https://github.com/Cosmo-mcp/cosmocp-desktop/releases' },
};
    ...
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
      ...
      <div className="mt-16 md:mt-24 relative max-w-6xl mx-auto px-4 perspective-1000">
        <motion.div
          ...
          animate={{ opacity: 1, rotateX: 0, y: 0, transition: { type: "spring", stiffness: 100, damping: 20, delay: 0.4 } }}
          whileHover={{ rotateX: 2.5, rotateY: -2.5, scale: 1.02, transition: { type: "spring", stiffness: 200, damping: 25 } }}
        ...
        >
          ...
          <div className="flex h-[400px] md:h-[600px]" ref={ref}>
            ...
            <div className="w-64 border-r border-white/10 bg-white/5 hidden md:flex flex-col p-4">
              ...
              <div className="text-xs font-medium text-muted-foreground/50 px-2 mb-3 uppercase tracking-wider">Recent</div>
              
              <div className="space-y-1">
                {["Marketing Strategy", "Refactor Auth", "Email Drafts", "SQL Queries", "Project Alpha"].map((item, i) => (
                  <div key={i} className="flex items-center gap-3 px-2 py-2 rounded-md text-sm text-muted-foreground hover:text-foreground hover:bg-white/5 cursor-pointer transition-colors">
              ...
              <div className="flex-1 space-y-6 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                ...
                <div className="flex justify-end opacity-40">
                  <div className="bg-primary/20 text-foreground px-4 py-2 rounded-2xl rounded-tr-sm max-w-[80%] text-sm">
                    Hey Cosmo, help me with this SQL query.
                  </div>
                </div>
...
function Typewriter({ text, shouldStart = false, delay = 0 }: { text: string, shouldStart?: boolean, delay?: number }) {
