      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-background/80 backdrop-blur-md supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-medium text-muted-foreground ml-[200px]">
            ...
            <Link href="https://docs.cosmocp.com" target='_blank' className="hover:text-foreground transition-colors">Docs</Link>
            ...
            >
              <div className="flex flex-col gap-6 h-full">
                ...
                <div className="flex flex-col gap-4">
                  <Link href="#features" onClick={() => setIsOpen(false)} className="text-sm font-medium hover:text-primary transition-colors">Features</Link>
                  <Link href="https://docs.cosmocp.com" target='_blank' onClick={() => setIsOpen(false)} className="text-sm font-medium hover:text-primary transition-colors">Docs</Link>
                  <Link href="#faq" onClick={() => setIsOpen(false)} className="text-sm font-medium hover:text-primary transition-colors">FAQ</Link>
                </div>
